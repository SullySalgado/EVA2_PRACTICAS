 ...
 * @author saul_
 */
public class dIBUJARDibujar extends javax.swing.JFrame {

    /**
     * Creates new form dIBUJARDibujar
     */
    public dIBUJARDibujar() {
        initComponents();
    }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        canvas1.getGraphics().fillOval(100, 100, 50, 100);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dIBUJARDibujar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dIBUJARDibujar().setVisible(true);
            }
        });
    }
